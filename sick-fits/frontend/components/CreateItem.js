...
class CreateItem extends Component {
  ...
  uploadFile = async (e) => {
    ...
    const res =await fetch('https://api.cloudinary.com/v1_1/shan2/image/upload', {method: 'Post', body: data})
    ...
    return (
      ...
      <Form onSubmit={ async (e) => {
        ...
        <fieldset disabled={loading} aria-busy={loading}>
          <label htmlFor="file">
            Image
            <input type="file" id="file" name="file" placeholder="file" required onChange={this.uploadFile} />
